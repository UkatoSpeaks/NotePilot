      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-500 font-bold max-w-xl">
                    Blast through high-yield summaries of your recently learned topics. Perfect for pre-exam jitters or daily retention.
                </p>
              </div>
              
              <div className="flex items-center gap-6 bg-white p-5 rounded-3xl border border-gray-100 shadow-2xl shadow-orange-900/5">
                <div className="text-right">
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Weekly Streak</p>
                  <p className="text-2xl font-black text-gray-900">4 Days</p>
                </div>
            ...
            <div className="grid lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-8 space-y-8">
                <section className="bg-white p-8 rounded-3xl border border-gray-100 shadow-2xl shadow-green-900/5">
                   <h3 className="text-xl font-black mb-6 flex items-center gap-3">
                     <Brain className="w-6 h-6 text-green-600" /> Choose Your Focus
                   </h3>
              ...
              <div className="lg:col-span-4 space-y-6">
                <div className="bg-[#2D6A4F] p-8 rounded-4xl text-white shadow-2xl shadow-green-900/20 relative overflow-hidden">
                   <div className="relative z-10 space-y-6">
                      <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center backdrop-blur-md">
                         <Rocket className="w-7 h-7 text-[#F9A11B]" />
                      </div>
                      <div className="space-y-3">
                         <h4 className="text-2xl font-black leading-tight">Ready for a Power Session?</h4>
                         <p className="text-white/60 font-bold text-sm">You have {selectedTopics.length} topics ready for review. This session will take about {selectedTopics.length * 2} minutes.</p>
                      </div>
                      <Button 
                        onClick={startRevision}
                        disabled={selectedTopics.length === 0}
                        className="w-full bg-[#F9A11B] hover:bg-white hover:text-[#2D6A4F] text-white rounded-xl py-6 text-lg font-black shadow-2xl shadow-orange-500/20 transition-all border-none flex items-center justify-center gap-3"
                      >
                         Initiate Blast Off
                ...
                <div className="p-6 rounded-3xl bg-white border border-gray-100 flex gap-4 items-center">
                   <div className="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600 italic font-black text-xl">i</div>
                   <div>
                      <p className="font-black text-gray-900 text-sm">Expert Tip</p>
                      <p className="text-xs font-bold text-gray-400 leading-relaxed">Early morning revisions lead to 25% better long-term retention according to neural studies.</p>
                   </div>
                </div>
              </div>
            </div>
        ...
        {state === "active_review" && (
          ...
          >
             ...
             <div className="relative">
                <AnimatePresence mode="wait">
                  <motion.div 
                    ...
                    className="bg-white p-8 md:p-14 rounded-4xl shadow-[0_50px_100px_-20px_rgba(45,106,79,0.1)] border border-gray-100 relative z-10"
                  >
                    <div className="space-y-8">
                       <h3 className="text-3xl md:text-4xl font-black text-gray-900 tracking-tight leading-tight text-center">
                       ...
                       <div className="space-y-8">
                          {activeCards[currentCardIndex].points.map((point, i) => (
                            ...
                            >
                               <div className="mt-1 w-6 h-6 rounded-lg bg-orange-50 flex items-center justify-center shrink-0 text-orange-600">
                                  <CheckCircle2 className="w-4 h-4" />
                               </div>
                               <p className="text-lg md:text-xl text-gray-600 font-bold leading-relaxed">{point}</p>
                            </motion.div>
                          ))}
                       </div>
                ...
                <div className="absolute top-6 left-6 -right-6 -bottom-6 bg-gray-50 rounded-4xl -z-10 border border-gray-100/50" />
                <div className="absolute top-12 left-12 -right-12 -bottom-12 bg-gray-100/30 rounded-4xl -z-20" />
             </div>
             ...
             <div className="flex justify-between items-center gap-6">
                ...
                <Button 
                  onClick={nextCard}
                  className="bg-[#2D6A4F] hover:bg-black text-white rounded-xl px-10 h-16 text-xl font-black shadow-2xl shadow-green-900/20 gap-4 flex-1 max-w-sm"
                >
        ...
        {state === "completed" && (
          <motion.div 
            ...
            animate={{ opacity: 1, scale: 1 }}
            className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto py-16 bg-white rounded-4xl border border-gray-100 shadow-2xl shadow-green-900/5 p-10"
          >
             <div className="relative mb-8">
                <div className="w-32 h-32 bg-orange-100 rounded-3xl flex items-center justify-center text-orange-600">
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-2 -right-2 w-12 h-12 bg-green-500 rounded-xl flex items-center justify-center border-4 border-white text-white"
                >
                   <CheckCircle2 className="w-6 h-6" />
                </motion.div>
             </div>
             
             <h2 className="text-4xl font-black text-gray-900 mb-2 tracking-tight">Mission Accomplished!</h2>
             <p className="text-lg text-gray-500 font-bold mb-10">You just reviewed {activeCards.length} high-yield topics in record time. Your brain is officially on fire.</p>
             ...
             <div className="grid grid-cols-2 gap-4 w-full mb-10">
                ...
                <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                   <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Confidence Level</p>
             ...
             <div className="flex flex-col sm:flex-row gap-4 w-full">
                <Button 
                  onClick={reset}
                  className="flex-1 bg-[#2D6A4F] hover:bg-black text-white rounded-xl py-6 text-lg font-black shadow-2xl shadow-green-900/20 gap-3"
                >
                   Done for Now
                </Button>
                <Button 
                  onClick={startRevision}
                  variant="outline"
                  className="flex-1 rounded-xl py-6 text-lg font-black border-2 gap-3"
                >
...
function RevisionTypeCard({ title, desc, icon, active }: { title: string, desc: string, icon: React.ReactNode, active: boolean }) {
    return (
        <div className={cn(
            ...
            <div className={cn(
                "w-12 h-12 rounded-xl flex items-center justify-center mb-6 shadow-lg transform group-hover:rotate-6 transition-transform",
